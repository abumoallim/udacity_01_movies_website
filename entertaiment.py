"""media contains Movie class which is data model"""
import media
"""fresh_tomatoes is a file to render movies object to html view"""
...
def main():
    ...
    harry_potter =  media.Movie('Harry Potter and the Chamber of Secrets',
    ...
    harry_potter_2 =  media.Movie('Harry Potter and the Prisoner of Azkaban',
